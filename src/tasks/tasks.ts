...
task("linkAvatarAndGuard")
    ...
    .setAction(async (
        ...
        const transHash = await avatar.connect(user1).getTransactionHash(avatar.address, 0, data, 0, 0, 0, 0, addressZero, addressZero, nonce);
        ...
        await avatar.connect(user1).execTransaction(avatar.address, 0, data, 0, 0, 0, 0, addressZero, addressZero, signature);
